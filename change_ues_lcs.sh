...
new_lc_each_ue=2  # New value for the number of logical channels for each UE
new_total_lc_traffic=8  # New value for total number of logical channels for traffic
new_total_lc_rlc=8  # New value for total number of logical channels in RLC layer
