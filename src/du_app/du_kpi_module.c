...
uint8_t kpmCalcCellMetric(){
    ...
    DU_LOG("\nJOJO --> KPM: overall performance, DL PRBUsed: %d, PRBTotal: %d, PRBUsage: %f, average DLtpt: %d", \
            kpmCellPmDb.avgUsedPrb, kpmCellPmDb.avgTotalPrb, kpmCellPmDb.avgUsagePrb, kpmCellPmDb.avgThpDl);
